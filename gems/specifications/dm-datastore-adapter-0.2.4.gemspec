...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "README", "Rakefile", "TODO", "lib/dm-datastore-adapter/datastore-adapter.rb", "lib/dm-datastore-adapter/merbtasks.rb", "lib/dm-datastore-adapter/transaction.rb", "lib/dm-datastore-adapter.rb", "spec/dm-datastore-adapter_spec.rb", "spec/spec_helper.rb"]
